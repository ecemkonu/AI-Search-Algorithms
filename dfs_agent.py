...
class DFSAgent(Agent):
    ...
    def solve(self, level_matrix, player_row, player_column):
        ...
        self.dfsStack.append(s0)

        maxSize = 0

        while self.dfsStack:

            curr_state = self.dfsStack.pop()
            ...
            if curr_state.level_matrix not in self.extendedLevels:
                ...
                if len(self.dfsStack) > maxSize:
                    maxSize = len(self.dfsStack)
